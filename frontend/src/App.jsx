...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addLog('正在分析构图参考图...');
      // 模拟处理步骤
      setTimeout(() => addLog('正在提取结构化约束...'), 1000);
      setTimeout(() => addLog('正在调整角色图比例...'), 2000);
      setTimeout(() => addLog('正在应用透视变换...'), 3000);
      setTimeout(() => addLog('正在生成融合图像...'), 4000);
      ...
      addLog('处理失败: ' + (error.response?.data?.message || error.message));
    } finally {
      setLoading(false);
    }
  };
